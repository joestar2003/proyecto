        ...
        <div style={{background: 'linear-gradient(90deg, #181c2a 60%, #181a20 100%)', border: '1.5px solid #ffd60033', borderRadius: 18, padding: 32, marginBottom: 32, display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', boxShadow: '0 4px 32px #0007'}}>
          <div style={{flex: 1, minWidth: 260}}>
            ...
            <div style={{display: 'flex', alignItems: 'center', gap: 18, marginBottom: 18}}>
              <span style={{fontSize: '2.2rem', fontWeight: 700, color: '#ffd600'}}>$ 500.000</span>
              <span style={{textDecoration: 'line-through', color: '#ffe08288', fontSize: '1.3rem', fontWeight: 500}}>$ 700.000</span>
              <span style={{background: '#ffd600', color: '#181a20', borderRadius: 8, fontWeight: 700, fontSize: 18, padding: '4px 14px'}}> -29% </span>
            </div>
